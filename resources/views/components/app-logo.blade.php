    ...
    >
        ...
        >
            @if($logoLight || $logoDark)
                @if($logoLight)
                    <img src="{{ $logoLight }}" class="h-9 w-auto object-contain dark:hidden" alt="{{ $appName }}" />
                @endif
                @if($logoDark)
                    <img src="{{ $logoDark }}" class="h-9 w-auto object-contain hidden dark:block" alt="{{ $appName }}" />
                @endif
            @else
