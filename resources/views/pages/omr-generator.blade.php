            ...
            <div class="p-3 bg-white border">
                <div class="bangla p-2 space-y-4">
                    ...
                    <div class="bg-gray-100 rounded-lg py-4 px-3 space-y-2 mt-4">
                        ...
                        <input data-page-model.live="schoolName" type="text"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input data-page-model.live="schoolNameSize" type="range" min="10" max="30" step="1" class="flex-1 accent-blue-600">
                            <span class="text-xs w-6 text-right">{{ $this->schoolNameSize }}</span>
                        </div>

                        <input data-page-model.live="address" type="text"
                               placeholder="ঠিকানা বা কাস্টম টেক্সট"
                               class="w-full rounded border border-gray-300 px-2 py-1 text-sm focus:outline-none focus:border-rose-400">

                        <div class="flex items-center gap-2">
                            <span class="text-xs text-gray-500 w-8">Size</span>
                            <input data-page-model.live="addressSize" type="range" min="10" max="20" step="1" class="flex-1 accent-blue-600">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex gap-3">
                            <div data-page-click="$set('templateType', 'iproshbang')"
                            ...
                            <div data-page-click="$set('templateType', 'standard')"
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-5 gap-2">
                                    ...
                                    @foreach($themeMap as $tKey => $tBg)
                                        <button data-page-click="updateTheme('{{ $tKey }}')"
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    @foreach(['SMALL', 'BIG'] as $hVal)
                                        <button data-page-click="$set('headerSize', '{{ $hVal }}')"
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2 flex-wrap">
                                        @foreach(['DIGITAL', 'MANUAL'] as $iVal)
                                            <button data-page-click="$set('infoType', '{{ $iVal }}')"
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    @foreach([40, 60, 80, 100] as $cnt)
                                        <button data-page-click="$set('questionCount', {{ $cnt }})"
                    ...
                    @else
                        ...
                        <div>
                            ...
                            <input data-page-model.live.debounce.500ms="questionCount" type="number" min="10" max="100"
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <button data-page-click="setColumns(2)"
                                ...
                                <button data-page-click="setColumns(3)"
                                ...
                                <button data-page-click="setColumns(4)" class="flex-1 h-10 border rounded flex gap-1 items-center justify-center transition {{ $this->columns == 4 ? 'border-gray-800 border-2 shadow-sm' : 'border-gray-300 hover:border-gray-400' }}">
