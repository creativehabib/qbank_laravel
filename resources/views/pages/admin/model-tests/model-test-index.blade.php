                    ...
                    @forelse($modelTests as $test)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <button type="button" data-page-click="delete({{ $test->id }})" data-page-confirm="Are you sure you want to delete this test?" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 font-semibold">Delete</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
