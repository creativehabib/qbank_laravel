<div> <!-- 🌟 Master Root Element for page controller 🌟 -->
    <div class="max-w-[100%] w-full mx-auto">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div class="flex flex-col gap-8 p-6 lg:p-8 w-full">
                {{-- ── Main Processing Area ── --}}
                <div class="flex-1 space-y-8 w-full">

                    {{-- 🤖 AI Bulk Question Generator --}}
                    <div data-page-key="ai-generator-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 rounded-2xl border border-indigo-100 dark:border-indigo-900 p-6 shadow-sm transition hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                            <div class="md:col-span-7">
                                ...
                                <input type="text" data-page-model="aiPrompt" placeholder="যেমন: বাংলাদেশের মুক্তিযুদ্ধ, আইসিটি ১ম অধ্যায়..." class="block w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 transition">
                            </div>

                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">প্রশ্নের সংখ্যা</label>
                                <input type="number" data-page-model="aiQuestionCount" min="1" max="50" class="block w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 transition text-center font-bold">
                            </div>

                            <div class="md:col-span-3">
                                <button type="button" data-page-click="generateBulkAiQuestions" data-page-loading.attr="disabled" class="w-full flex items-center justify-center gap-2 px-5 py-3 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white text-sm font-bold rounded-xl shadow-md transition-all h-[46px]">
                                    <span data-page-loading.remove data-page-target="generateBulkAiQuestions">Generate AI MCQ</span>
                                    <span data-page-loading.flex data-page-target="generateBulkAiQuestions" class="items-center justify-center gap-2">
                    ...
                    {{-- ── Settings & Image/PDF Upload ── --}}
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {{-- Image/PDF Upload Card (🌟 Alpine.js + data-page-ignore applied to prevent reload) --}}
                        <div data-page-key="image-upload-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm space-y-4 transition hover:shadow-md h-full">
                            ...
                            <div data-page-loading data-page-target="sourceFile" class="flex justify-center items-center gap-2 text-sm font-bold text-indigo-600 dark:text-indigo-400">
                        ...
                        {{-- Settings Card --}}
                        <div data-page-key="settings-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm space-y-5 h-full transition hover:shadow-md">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select data-page-model="difficulty" class="w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-3 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 transition shadow-sm">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Marks (Per Question)</label>
                                    <div class="relative">
                                        <input type="number" min="0.25" step="0.25" data-page-model="marks" class="w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-indigo-500 transition shadow-sm pr-12">
                    ...
                    {{-- Raw Text Textarea --}}
                    <div data-page-key="ocr-raw-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm transition hover:shadow-md">
                        ...
                        <div data-page-ignore data-page-key="raw-editor-box" class="ck-editor-container">
                    ...
                    {{-- Action Buttons --}}
                    <div data-page-key="action-buttons-card" class="flex flex-wrap items-center gap-3 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-4 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm">

                        <label class="flex items-center gap-2 mr-4 cursor-pointer">
                            <input type="checkbox" data-page-model="enrichWithAi" class="w-5 h-5 rounded border-indigo-300 text-indigo-600 focus:ring-indigo-500 bg-white dark:bg-gray-900 dark:border-gray-700">
                            <span class="text-sm font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
                                <svg class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                AI দিয়ে সঠিক উত্তর ও ক্যাটাগরি নির্বাচন করুন
                            </span>
                        </label>

                        <button type="button" data-page-click="processQuestions"
                                data-page-loading.attr="disabled" data-page-target="processQuestions,sourceFile"
                            ...
                            <span data-page-loading.remove data-page-target="processQuestions">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                </svg>
                            </span>
                            <span data-page-loading data-page-target="processQuestions">
                                <svg class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"/>
                                </svg>
                            </span>
                            <span data-page-loading.remove data-page-target="processQuestions">Process Questions</span>
                            <span data-page-loading data-page-target="processQuestions">
                                @if($sourceFile && trim($rawText) === '') OCR চলছে... @else Processing... @endif
                            </span>
                        </button>

                        <button type="button" data-page-click="submitProcessedQuestions"
                                data-page-loading.attr="disabled" data-page-target="submitProcessedQuestions"
                            @class([
                            ...
                            <span data-page-loading.remove data-page-target="submitProcessedQuestions">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                </svg>
                            </span>
                            <span data-page-loading data-page-target="submitProcessedQuestions">
                                <svg class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"/>
                                </svg>
                            </span>
                            <span data-page-loading.remove data-page-target="submitProcessedQuestions">Submit to Database</span>
                            <span data-page-loading data-page-target="submitProcessedQuestions">Submitting...</span>
                        </button>

                        <a href="{{ route('questions.index') }}" data-navigate="false"
                    ...
                    <div data-page-loading data-page-target="processQuestions"
                    ...
                    @if(! empty($processedQuestions))
                        <div data-page-key="processed-questions-card" class="rounded-2xl border border-indigo-200 dark:border-indigo-800 shadow-sm overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 transition">
                            ...
                            <div class="p-5 space-y-5" id="processed-questions-container"
                                 x-data="{
                                     init() {
                                         let timeout;
                                         const renderMath = () => {
                                ...
                                @foreach($processedQuestions as $questionIndex => $question)
                                    ...
                                    @endphp
                                    <div data-page-key="question-{{ $questionIndex }}" @class([
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex flex-shrink-0 items-center gap-2 mt-0.5">
                                                @if($hasCorrect)
                                                    <span class="inline-flex items-center gap-1.5 text-sm text-green-700 dark:text-green-400 font-bold bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700 px-3 py-2 rounded-lg shadow-sm">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                                                        চিহ্নিত
                                                    </span>
                                                @else
                                                    <span class="inline-flex items-center gap-1.5 text-sm text-red-700 dark:text-red-400 font-bold bg-red-100 dark:bg-red-900/40 border border-red-300 dark:border-red-700 px-3 py-2 rounded-lg shadow-sm animate-pulse">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                                                        চিহ্নিত নেই
                                                    </span>
                                                @endif
                                                <button type="button" data-page-click="removeProcessedQuestion({{ $questionIndex }})" title="প্রশ্নটি মুছে ফেলুন" class="inline-flex items-center justify-center p-2 rounded-lg text-red-500 hover:text-white hover:bg-red-500 dark:text-red-400 dark:hover:text-white dark:hover:bg-red-500 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 transition-colors shadow-sm">
                                        ...
                                        @if(!empty($question['is_duplicate']))
                                            <div class="flex items-center justify-between ml-11 mb-2 mt-[-0.25rem] px-3 py-2 text-xs font-semibold rounded-lg bg-orange-100 text-orange-800 border border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800">
                                                ...
                                                <button type="button" data-page-click="removeProcessedQuestion({{ $questionIndex }})" title="বাতিল করুন" class="flex items-center justify-center p-1 rounded-md text-orange-600 hover:text-white hover:bg-orange-600 dark:text-orange-400 dark:hover:bg-orange-500 transition-colors">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6 18L18 6M6 6l12 12"></path></svg>
                                                </button>
                                            </div>
                                        @endif

                                        {{-- 🌟 Tags & Categorization Grid --}}
                                        <div class="ml-11 mb-3 mt-1 grid grid-cols-1 lg:grid-cols-2 gap-4 border border-gray-100 dark:border-gray-800 rounded-xl p-3 bg-gray-50/50 dark:bg-gray-800/30">
                                            ...
                                            <div x-data="{
                                                ...
                                                <div class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 font-medium mb-2">
                                                ...
                                                <div class="flex flex-wrap items-center gap-2">
                                                    <template x-for="(tag, index) in tags" :key="index">
                                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 text-[11px] font-semibold text-indigo-700 bg-indigo-100 dark:bg-indigo-900/40 dark:text-indigo-300 rounded-md border border-indigo-200 dark:border-indigo-800">
                                                    ...
                                                    <div class="relative flex items-center">
                                                        <input type="text"
                                                               ...
                                                               class="w-28 text-xs px-2 py-1 text-gray-700 dark:text-gray-300 border border-dashed border-gray-300 dark:border-gray-600 rounded-md bg-white hover:bg-gray-50 focus:bg-white dark:bg-gray-900/50 dark:hover:bg-gray-800 dark:focus:bg-gray-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all outline-none">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 font-medium mb-2">
                                                    ...
                                                    ক্যাটাগরি: <span class="text-red-500 font-bold">*</span>
                                                </div>
                                                <div class="flex flex-wrap items-center gap-2">
                                                    <!-- Subject -->
                                                    <select data-page-model.live="processedQuestions.{{$questionIndex}}.subject_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500 @empty($question['subject_id']) border-red-200 dark:border-red-900/50 bg-red-50/30 dark:bg-red-900/10 @endempty">
                                                        <option value="">- Subject - *</option>
                                                        @foreach($subjectsTree as $st)
                                                    ...
                                                    <!-- Chapter -->
                                                    @php
                                                        $qSubId = $question['subject_id'] ?? null;
                                                        $qChapters = $qSubId ? $subjectsTree->where('id', $qSubId)->first()?->chapters ?? [] : [];
                                                    @endphp
                                                    @if(count($qChapters) > 0 || $qSubId)
                                                    ...
                                                    <select data-page-model.live="processedQuestions.{{$questionIndex}}.chapter_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500">
                                                        <option value="">- Chapter -</option>
                                                        @foreach($qChapters as $qc)
                                                    ...
                                                    <!-- Topic -->
                                                    @php
                                                        $qChapId = $question['chapter_id'] ?? null;
                                                        $qTopics = $qChapId && count($qChapters) > 0 ? collect($qChapters)->where('id', $qChapId)->first()?->topics ?? [] : [];
                                                    @endphp
                                                    @if(count($qTopics) > 0 || $qChapId)
                                                    <svg class="w-3 h-3 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                                                    <select data-page-model="processedQuestions.{{$questionIndex}}.topic_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500">
                                                        <option value="">- Topic -</option>
                                                        @foreach($qTopics as $qt)
                                            ...
                                            {{-- Full Width: Target Audience (Classes) --}}
                                            <div class="lg:col-span-2 mt-1 border-t border-gray-100 dark:border-gray-800 pt-3">
                                                <div class="flex flex-col gap-2">
                                                    <div class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 font-medium">
                                                        ...
                                                        Target Audience (Classes): <span class="text-red-500 font-bold">*</span>
                                                    </div>
                                                    <div data-page-ignore x-data="{
                                                        ts: null,
                                                        classIds: @entangle('processedQuestions.' . $questionIndex . '.academic_class_ids'),
                                                        init() {
                                                            if(window.TomSelect) {
                                                                this.ts = new TomSelect(this.$refs.classes, {
                                                                    plugins: ['remove_button'],
                                                                    placeholder: 'Select Classes... *',
                                                                    onChange: (v) => {
                                                                        let val = Array.isArray(v) ? v : (v ? [v] : []);
                                                                        this.classIds = val;
                                                                        $page.set('processedQuestions.{{ $questionIndex }}.academic_class_ids', val, false);
                                                                    }
                                                                });
                                                                this.$watch('classIds', (value) => {
                                                                    if (this.ts) {
                                                    ...
                                                    }" class="w-full @empty($question['academic_class_ids']) rounded border border-red-200 dark:border-red-900/50 bg-red-50/30 dark:bg-red-900/10 @endempty">
                                                        <select x-ref="classes" multiple class="w-full text-sm">
                                                            @foreach($classes as $c)
                                                                <option value="{{ $c->id }}" @selected(in_array($c->id, $question['academic_class_ids'] ?? []))>{{ $c->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        @error('processedQuestions.'.$questionIndex.'.subject_id') <p class="ml-11 mb-2 mt-[-0.5rem] text-xs font-medium text-red-500">{{ $message }}</p> @enderror
                                        @error('processedQuestions.'.$questionIndex.'.academic_class_ids') <p class="ml-11 mb-2 mt-[-0.5rem] text-xs font-medium text-red-500">{{ $message }}</p> @enderror

                                        {{-- 🌟 AI Explanation Preview --}}
                                        @if(!empty($question['explanation']))
                                            <div class="ml-11 mb-3 mt-1 p-3 rounded-lg bg-emerald-50 border border-emerald-100 dark:bg-emerald-900/10 dark:border-emerald-900/30 relative group">
                                                <div class="flex items-start gap-2 pr-8">
                                                    ...
                                                    <div class="text-xs text-emerald-800 dark:text-emerald-200 leading-relaxed tex2jax_process" data-math-content>
                                                        <span class="font-semibold block mb-0.5">ব্যাখ্যা:</span>
                                                        {{ $question['explanation'] }}
                                                    </div>
                                                </div>
                                                <button type="button" data-page-click="$set('processedQuestions.{{ $questionIndex }}.explanation', '')" title="ব্যাখ্যা মুছে ফেলুন" class="absolute top-2 right-2 p-1.5 rounded-md text-emerald-400 hover:text-white hover:bg-red-500 transition-colors opacity-0 group-hover:opacity-100">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pl-11">
                                            @foreach($question['options'] as $optionIndex => $option)
                                                ...
                                                <div data-page-key="option-{{ $questionIndex }}-{{ $optionIndex }}" @class([
                                                    ...
                                                    <button type="button"
                                                            data-page-click="setCorrectOption({{ $questionIndex }}, {{ $optionIndex }})"
...
@push('scripts')
    ...
    <script>
        ...
        if (!window.hasRegisteredBulkUploadEvents) {
            ...
            window.updatePageState = (property, value) => {
            ...
            window.initBulkUploadTomSelect = () => {
                ...
                if (typeof TomSelect !== 'undefined') {
                    ...
                    if (classEl && !classEl.tomselect) window.tsClass = new TomSelect(classEl, {...tsMultiConfig, placeholder: '-- Select Class --', onChange: (v) => window.updatePageState('academic_class_ids', v) });

                    const subjectEl = document.getElementById('subject');
                    if (subjectEl && !subjectEl.tomselect) window.tsSubject = new TomSelect(subjectEl, {...tsConfig, placeholder: '-- Select Subject --', onChange: (v) => window.updatePageState('subject_id', v) });

                    const chapterEl = document.getElementById('chapter');
                    if (chapterEl && !chapterEl.tomselect) window.tsChapter = new TomSelect(chapterEl, {...tsConfig, placeholder: '-- Select Chapter --', onChange: (v) => window.updatePageState('chapter_id', v) });

                    const topicEl = document.getElementById('topic');
                    if (topicEl && !topicEl.tomselect) window.tsTopic = new TomSelect(topicEl, {...tsConfig, placeholder: '-- Select Topic --', onChange: (v) => window.updatePageState('topic_id', v) });
                }
            };
            ...
            if (document.readyState === 'complete' || document.readyState === 'interactive') {
                setTimeout(window.initBulkUploadComponents, 100);
            }
            document.addEventListener('DOMContentLoaded', () => setTimeout(window.initBulkUploadComponents, 100));
            document.addEventListener('page:initialized', () => setTimeout(window.initBulkUploadComponents, 100));
            document.addEventListener('page:navigated', () => setTimeout(window.initBulkUploadComponents, 100));

            document.addEventListener('page:navigating', () => {
