<div x-data="{ questionType: $page.entangle('question_type') }" class="w-full !max-w-full mx-auto">
    ...
    <div class="mb-8 p-6 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="shrink-0 self-start sm:self-auto">
            <a href="{{ route('questions.index') }}" data-navigate="false" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow transition-all duration-200">
    ...
    <form data-page-submit.prevent="save" class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div class="flex-1 space-y-8 w-full">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm transition hover:shadow-md">
                ...
                <div class="flex flex-col md:flex-row gap-3">
                    <div class="flex-1 w-full relative">
                        <input type="text" data-page-model="aiPrompt" placeholder="কী নিয়ে প্রশ্ন বানাতে চান? (যেমন: বাংলাদেশের স্বাধীনতা যুদ্ধ)" class="w-full px-4 py-3 rounded-xl border border-indigo-200 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-900 dark:border-indigo-800 dark:text-white dark:placeholder-gray-500 h-[50px] text-base transition">
                    </div>

                    <button type="button" data-page-click="generateAiQuestion" data-page-loading.attr="disabled" class="w-full md:w-auto px-7 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2.5 shrink-0 h-[50px] text-base">
                        <span data-page-loading.remove data-page-target="generateAiQuestion" class="flex items-center gap-2">
                        ...
                        <span data-page-loading.flex data-page-target="generateAiQuestion" class="items-center justify-center gap-2.5">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 space-y-8">
                ...
                <section>
                    ...
                    <div data-page-ignore class="ck-editor-container">
                ...
                <section x-show="['written', 'short'].includes(questionType)" style="display: none;" x-transition class="pt-6 border-t dark:border-gray-800">
                    ...
                    <div class="p-4 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-2xl hover:border-indigo-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30">
                        <input type="text" name="image" value="{{ old('image', $image ?? null) }}" class="w-full rounded-lg border border-zinc-300 px-3 py-2" placeholder="Storage path or image URL">
                    </div>
                </section>
                ...
                <section x-show="questionType === 'mcq'" x-transition class="pt-8 border-t dark:border-gray-800">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
                        ...
                        <button type="button" data-page-click="addOption" class="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-5 py-2.5 rounded-xl shadow hover:shadow-lg text-sm font-bold transition-all">
                    ...
                    <div class="space-y-6 bg-gray-50 dark:bg-gray-800/50 p-5 md:p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-inner">
                        ...
                        @foreach($options as $i => $opt)
                            <div data-page-key="opt-{{ $i }}" class="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm relative duration-200 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-800 group">

                                <button type="button" data-page-click="removeOption({{ $i }})" class="absolute -top-3 -right-3 bg-red-100 dark:bg-red-950 hover:bg-red-600 text-red-600 dark:text-red-400 hover:text-white rounded-full p-2 shadow-md transition opacity-100 sm:opacity-0 group-hover:opacity-100 z-10">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-4 pr-0 sm:pr-6">
                                    ...
                                    <label class="flex items-center gap-2 sm:ml-auto cursor-pointer bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-2 rounded-xl transition hover:bg-green-50 dark:hover:bg-green-950 has-[:checked]:border-green-400">
                                        <input type="checkbox" data-page-model="options.{{ $i }}.is_correct" class="rounded text-green-600 h-5 w-5 border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-green-400" @if(!empty($opt['is_correct']) && $opt['is_correct']) checked @endif>
                                        <span class="text-sm font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wide">Correct Answer</span>
                                    </label>
                                </div>

                                <div data-page-ignore class="ck-editor-container options-editor">
                ...
                <section x-show="questionType === 'cq'" style="display: none;" x-transition class="pt-8 border-t dark:border-gray-800">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
                        ...
                        <button type="button" data-page-click="addCqPart" class="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-xl shadow hover:shadow-lg text-sm font-bold transition-all">
                    ...
                    <div class="space-y-6 bg-gray-50 dark:bg-gray-800/50 p-5 md:p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-inner">
                        @foreach($cq as $index => $part)
                            <div data-page-key="cq-part-{{ $part['id'] ?? $index }}" class="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm relative transition-all duration-200 hover:shadow-md hover:border-purple-300 dark:hover:border-purple-800 group">

                                <button type="button" data-page-click="removeCqPart({{ $index }})" class="absolute -top-3 -right-3 bg-red-100 dark:bg-red-950 hover:bg-red-600 text-red-600 dark:text-red-400 hover:text-white rounded-full p-2 shadow-md transition opacity-100 sm:opacity-0 group-hover:opacity-100 z-10">
                                    <svg class="size-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 352 512" xmlns="http://www.w3.org/2000/svg"><path d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z"></path></svg>
                                </button>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <input type="text" data-page-model.live="cq.{{ $index }}.label" class="w-16 font-extrabold text-center bg-purple-100 dark:bg-purple-900/50 text-purple-950 dark:text-purple-200 rounded-lg border border-purple-200 dark:border-purple-800 focus:ring-2 focus:ring-purple-400 py-2 text-lg" placeholder="ক">
                                    </div>
                                    <div class="flex items-center gap-2.5 sm:ml-auto bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700">
                                        ...
                                        <input type="number" data-page-model.live="cq.{{ $index }}.marks" class="w-20 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-center font-bold focus:ring-purple-400 py-1.5" min="0" step="0.5">
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <span class="text-sm font-bold text-gray-600 dark:text-gray-300 uppercase block mb-2 tracking-wide">Question (প্রশ্ন)</span>
                                    <div data-page-ignore class="ck-editor-container cq-editor">
                                ...
                                <div x-data="{
                                    ...
                                    <div x-show="showAnswer" x-transition class="mt-4" style="display: none;">
                                        <div data-page-ignore class="ck-editor-container answer-editor">
                ...
                <section class="pt-8 border-t dark:border-gray-800">
                    ...
                    <div data-page-ignore class="ck-editor-container description-editor">
        ...
        <div class="w-full lg:w-[360px] xl:w-[420px] space-y-8 shrink-0 lg:sticky lg:top-24">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-7 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 space-y-6">
                ...
                <div class="space-y-5">
                    <div data-page-ignore data-page-key="subject-select-{{ $question->id ?? 'create' }}">
                    ...
                    <div data-page-ignore data-page-key="subsubject-select-{{ $question->id ?? 'create' }}">
                    ...
                    <div data-page-ignore data-page-key="topic-select-{{ $question->id ?? 'create' }}">
                    ...
                    <div data-page-ignore data-page-key="class-select-{{ $question->id ?? 'create' }}">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-7 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 space-y-6">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <select data-page-model="difficulty" class="block w-full px-3 py-2.5 text-base rounded-xl border border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <select data-page-model.live="question_type" class="block w-full px-3 py-2.5 text-base rounded-xl border border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-gray-200 font-medium">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-xl shadow-sm">
                            <input type="number" step="0.5" min="0" data-page-model.live="marks"
...
@push('scripts')
    ...
    <script>
        ...
        function initCkEditor4(elementId, pageProperty, isAdvanced = false) {
            if (window.initGlobalCkEditor) {
                return window.initGlobalCkEditor(elementId, @this, pageProperty, isAdvanced);
            }
        }
        ...
        function initEditors() {
            ...
            if (typeof TomSelect !== 'undefined') {
                ...
                const updatePageState = (property, value) => {
                ...
                if (classEl && !classEl.tomselect) window.tsClass = new TomSelect(classEl, {...tsMultiConfig, placeholder: '-- Select Class --', onChange: (v) => updatePageState('academic_class_ids', v) });

                const subjectEl = document.getElementById('subject');
                if (subjectEl && !subjectEl.tomselect) window.tsSubject = new TomSelect(subjectEl, {...tsConfig, placeholder: '-- Select Subject --', onChange: (v) => updatePageState('subject_id', v) });

                const chapterEl = document.getElementById('chapter');
                if (chapterEl && !chapterEl.tomselect) window.tsChapter = new TomSelect(chapterEl, {...tsConfig, placeholder: '-- Select Chapter --', onChange: (v) => updatePageState('chapter_id', v) });

                const topicEl = document.getElementById('topic');
                if (topicEl && !topicEl.tomselect) window.tsTopic = new TomSelect(topicEl, {...tsConfig, placeholder: '-- Select Topic --', onChange: (v) => updatePageState('topic_id', v) });

                const tagsEl = document.getElementById('tags');
                if (tagsEl && !tagsEl.tomselect) window.tsTags = new TomSelect(tagsEl, {...tsMultiConfig, onChange: (v) => updatePageState('tagIds', v) });
        ...
        if (!window.hasRegisteredQuestionEvents) {
            ...
            document.addEventListener('DOMContentLoaded', () => setTimeout(initEditors, 100));
            document.addEventListener('page:initialized', () => setTimeout(initEditors, 100));
            document.addEventListener('page:navigated', () => setTimeout(initEditors, 100));
