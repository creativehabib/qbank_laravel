            ...
            @forelse($pendingTransactions as $transaction)
                <tr class="border-t border-zinc-200 dark:border-zinc-700">
                    ...
                    <td class="py-2 space-x-2">
                        <button data-page-click="approve({{ $transaction->id }})" class="rounded bg-emerald-600 px-3 py-1 text-white">Approve</button>
                        <button data-page-click="reject({{ $transaction->id }})" class="rounded bg-rose-600 px-3 py-1 text-white">Reject</button>
                    </td>
                </tr>
            @empty
