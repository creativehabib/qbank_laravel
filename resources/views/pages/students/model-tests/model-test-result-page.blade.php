    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm relative overflow-hidden">
            ...
            <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                <a href="{{ route('student.model-tests.index') }}" data-page-navigate class="px-6 py-3 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 font-bold rounded-xl transition text-center">
                    Back to Model Tests
                </a>
                <a href="{{ route('dashboard') }}" data-page-navigate class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition shadow-sm text-center">
                    Go to Dashboard
                </a>
            </div>
        </div>
