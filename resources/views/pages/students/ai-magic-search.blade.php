<div class="relative w-full max-w-3xl mx-auto z-40">
    <div class="relative group">
        ...
        <form data-page-submit="search" class="relative flex items-center bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm p-1.5 focus-within:ring-2 focus-within:ring-indigo-500">
