<div class="max-w-7xl mx-auto pb-12">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <x-ui.heading size="xl">System Information</x-ui.heading>
                <x-ui.subheading>View technical specifications and runtime configuration of the server.</x-ui.subheading>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl">
        <x-ui.card>
            <x-ui.heading size="lg" class="mb-4">Environment Details</x-ui.heading>
            ...
            <div class="mt-6 flex justify-end">
                <x-ui.button variant="outline" icon="arrow-path" data-page-click="$refresh">Refresh Data</x-ui.button>
            </div>
        </x-ui.card>
    </div>
</div>