<div x-data="{ open: false }"
    ...
    <div x-show="open"
        ...
        <div x-show="open"
            ...
            <form data-page-submit.prevent="search">
                <div class="relative flex items-center p-4 border-b border-slate-100 dark:border-zinc-800">
                    ...
                    <input data-page-model.live.debounce.300ms="query"
                           x-ref="searchInput"
                    ...
                    <div data-page-loading data-page-target="query" class="absolute right-16">
