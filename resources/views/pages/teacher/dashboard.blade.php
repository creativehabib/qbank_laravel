    ...
    <div class="grid gap-6 lg:grid-cols-3">
        <div class="space-y-6 lg:col-span-2">
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                ...
                <div class="px-4 pb-6 pt-2 md:px-6">
                    <div class="relative h-72">
                        <div data-page-ignore id="activityChart" class="h-full"></div>
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                ...
                <div class="px-4 pb-6 pt-2 md:px-6">
                    <div class="relative h-72">
                        <div data-page-ignore id="subjectChart" class="h-full"></div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-left text-sm dark:divide-gray-800">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-900">
                            @forelse ($questionSets as $questionSet)
                                <tr data-page-key="question-set-{{ $questionSet->id }}" class="transition hover:bg-gray-50 dark:hover:bg-gray-800/60">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button
                                                x-data x-on:click="window.confirmDeleteAction(() => $page.deleteQuestionSet('{{ $questionSet->id }}'))"
        ...
        document.addEventListener('page:initialized', () => {
            ...
            waitForApexCharts(ApexCharts => {
                ...
                if (window.__teacherDashboardNavigatedListener) {
                    document.removeEventListener('page:navigated', window.__teacherDashboardNavigatedListener);
                }

                window.__teacherDashboardNavigatedListener = navigatedListener;
                document.addEventListener('page:navigated', navigatedListener);
                ...
                if (!window.__teacherDashboardMessageHookRegistered) {
                    window.addEventListener('message.processed', () => {
