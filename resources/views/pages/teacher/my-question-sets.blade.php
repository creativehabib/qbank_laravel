<div class="mx-auto w-full max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between gap-3">
        ...
        <a href="{{ route('question.set-create') }}" class="inline-flex items-center rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700" data-page-navigate>
            + নতুন তৈরি করুন
        </a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-wrap gap-2">
                                    <a href="{{ route('questions.view', ['qset' => $questionSet->id]) }}" class="inline-flex items-center rounded-md border border-zinc-300 px-3 py-1.5 text-xs font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-600 dark:text-zinc-200 dark:hover:bg-zinc-800" data-page-navigate>
                                        দেখুন
                                    </a>
                                    <a href="{{ route('questions.paper', ['qset' => $questionSet->id]) }}" class="inline-flex items-center rounded-md bg-zinc-900 px-3 py-1.5 text-xs font-medium text-white hover:bg-zinc-700 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-300" data-page-navigate>
                                        Paper
                                    </a>
                                    <a href="{{ route('pdf.download', $questionSet->id) }}" target="_blank" class="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50">
                                        <x-ui.icon.document-arrow-down class="size-4" />
                                        {{ __('PDF ডাউনলোড করুন') }}
                                    </a>
                                </div>
                            </td>
