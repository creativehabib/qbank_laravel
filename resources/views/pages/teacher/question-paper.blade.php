    ...
    <div class="bangla flex flex-col lg:flex-row lg:items-start justify-center gap-5 print:gap-0 mx-4 print:mx-0">
        ...
        <div class="print:hidden flex gap-x-2 justify-between sticky top-12 lg:hidden p-2 text-center z-10 bg-white">
            ...
            <button class="flex justify-center gap-1 items-center border py-1 px-2 bg-white rounded" tabindex="0">
                ...
                </svg><span>উত্তরমালা</span>
            </button> <!-- Removed stray 'া' -->
            <button class="flex justify-center gap-1 items-center border py-1 px-2 bg-white rounded" tabindex="0">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-gray-600 text-xs" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="print-area relative w-full md:overflow-auto lg:w-[210mm] lg:shrink-0">
            ...
            <div class="w-full p-[5mm] md:p-[10mm] print:p-0.5 print:w-full print:shadow-none bg-white">
                <div class="relative py-2 print:py-0">
                    <h1 class="text-xl font-bold text-center">{{ $organizationName }}</h1>
                    ...
                    @endif
                    <div class="relative">
                        <p contenteditable="true" class="text-center text-lg">{{ $subject->name ?? 'N/A' }}</p>
                    ...
                    @if($previewOptions['showWatermark'])
                        <div class="fixed top-0 left-0 w-full h-full flex justify-center items-center pointer-events-none z-10">
                            <p
                                ...
                                style="opacity: {{ $watermarkOpacity / 100 }}; font-size: {{ $watermarkSize }}px;">
                                {{ $organizationName }}
                            </p>
                        </div>
                    @endif
                        ...
                        <div class="relative w-full mt-4" style="column-count: {{ $columnCount }}; {{ ($previewOptions['showColumnDivider'] ?? true) && $columnCount > 1 ? 'column-rule: 1px solid rgba(0,0,0,0.3);' : 'column-rule: none;' }} column-gap: 8mm;">
                            @forelse ($questions as $question)
                                <div class="false bg-white relative p-0.5 hover:bg-gray-50 rounded group">
                                    ...
                                    {{-- MCQ (বহুনির্বাচনী) অপশন শো করার লজিক --}}
                                    @php
                                        $mcqOptions = [];
                ...
                <div class="bg-white backdrop-blur-lg p-2">
                        ...
                        <div>
                            <div class="bg-gray-100 p-2 rounded flex justify-between items-center my-1"><span class="bangla">উত্তরপত্র</span>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer" data-page-model.live="previewOptions.attachAnswerSheet">
                            ...
                            <div class="bg-gray-100 p-2 rounded flex justify-between items-center my-1"><span class="bangla">প্রশ্নের মান (Marks)</span>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer" data-page-model.live="previewOptions.showMarksBox">
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:peer-focus:ring-emerald-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
                                </label>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-100 p-1">
                                ...
                                <div class="flex gap-2 py-1">
                                    <button data-page-click="setTextAlign('left')" class="p-2 rounded {{ $textAlign === 'left' ? 'bg-emerald-600 shadow text-white' : 'text-gray-500 hover:text-gray-800' }}" title="left">
                                    ...
                                    <button data-page-click="setTextAlign('center')" class="p-2 rounded {{ $textAlign === 'center' ? 'bg-emerald-600 shadow text-white' : 'text-gray-500 hover:text-gray-800' }}" title="center">
                                    ...
                                    <button data-page-click="setTextAlign('right')" class="p-2 rounded {{ $textAlign === 'right' ? 'bg-emerald-600 shadow text-white' : 'text-gray-500 hover:text-gray-800' }}" title="right">
                                    ...
                                    <button data-page-click="setTextAlign('justify')" class="p-2 rounded {{ $textAlign === 'justify' ? 'bg-emerald-600 shadow text-white' : 'text-gray-500 hover:text-gray-800' }}" title="justify">
                            ...
                            <div class="my-1">
                                ...
                                <div class="grid grid-cols-4 gap-1.5">
                                    <div data-page-click="setPaperSize('A4')" class="flex-1 flex flex-col items-center justify-center cursor-pointer px-2 py-2 border rounded text-sm capitalize select-none {{ $paperSize === 'A4' ? 'bg-emerald-50 border-emerald-500' : 'border-gray-200 hover:bg-gray-200' }}">
                                        <div class="mb-1 border shadow bg-white" style="min-width: 42.4242px; min-height: 60px;"></div>A4</div>
                                    <div data-page-click="setPaperSize('Letter')" class="flex-1 flex flex-col items-center justify-center cursor-pointer px-2 py-2 border rounded text-sm capitalize select-none {{ $paperSize === 'Letter' ? 'bg-emerald-50 border-emerald-500' : 'border-gray-200 hover:bg-gray-200' }}">
                                        <div class="mb-1 border shadow bg-white" style="min-width: 45px; min-height: 58.125px;"></div>Letter</div>
                                    <div data-page-click="setPaperSize('Legal')" class="flex-1 flex flex-col items-center justify-center cursor-pointer px-2 py-2 border rounded text-sm capitalize select-none {{ $paperSize === 'Legal' ? 'bg-emerald-50 border-emerald-500' : 'border-gray-200 hover:bg-gray-200' }}">
                                        <div class="mb-1 border shadow bg-white" style="min-width: 36.4045px; min-height: 60px;"></div>Legal</div>
                                    <div data-page-click="setPaperSize('A5')" class="flex-1 flex flex-col items-center justify-center cursor-pointer px-2 py-2 border rounded text-sm capitalize select-none {{ $paperSize === 'A5' ? 'bg-emerald-50 border-emerald-500' : 'border-gray-200 hover:bg-gray-200' }}">
                            ...
                            <div class="relative bg-gray-100 p-2 rounded my-1">
                                ...
                                <div class="flex gap-2">
                                    <div data-page-click="setOptionStyle('circle')" class="p-1 flex-1 flex justify-center items-center cursor-pointer {{ ($optionStyle ?? 'circle') === 'circle' ? 'bg-emerald-600 text-white shadow' : 'bg-white hover:bg-emerald-100 text-gray-700' }}">
                                        <div class="h-5 w-5 border {{ ($optionStyle ?? 'circle') === 'circle' ? 'border-white' : 'border-gray-500' }} rounded-full bg-white"></div>
                                    </div>
                                    <div data-page-click="setOptionStyle('dot')" class="p-1 flex-1 flex justify-center items-center cursor-pointer {{ ($optionStyle ?? 'circle') === 'dot' ? 'bg-emerald-600 text-white shadow' : 'bg-white hover:bg-emerald-100 text-gray-700' }}">.</div>
                                    <div data-page-click="setOptionStyle('parentheses')" class="p-1 flex-1 flex justify-center items-center cursor-pointer {{ ($optionStyle ?? 'circle') === 'parentheses' ? 'bg-emerald-600 text-white shadow' : 'bg-white hover:bg-emerald-100 text-gray-700' }}">( )</div>
                                    <div data-page-click="setOptionStyle('minimal')" class="p-1 flex-1 flex justify-center items-center cursor-pointer {{ ($optionStyle ?? 'circle') === 'minimal' ? 'bg-emerald-600 text-white shadow' : 'bg-white hover:bg-emerald-100 text-gray-700' }}">)</div>
                                </div>
                            </div>
                            <div class="bg-gray-100 my-1 p-2">
                                <div class="rounded justify-between items-center">
                                    ...
                                    <select id="font-selector" data-page-model.live="fontFamily" class="w-full rounded-md border border-gray-300">
                            ...
                            <div class="bg-gray-100 p-2 rounded flex justify-between items-center my-1"><span class="bangla">ফন্ট সাইজ </span>
                                <div class="flex items-center gap-1">
                                    <button data-page-click="decreaseFontSize" class="hover:bg-white px-2 rounded text-lg">-</button>
                                    <p class="border rounded p-0.5 px-1.5 bg-white">{{ $fontSize }}</p>
                                    <button data-page-click="increaseFontSize" class="hover:bg-white px-2 rounded text-lg">+</button>
                                </div>
                            </div>
                            <div class="my-1">
                                <p>কলাম</p>
                                <div class="flex gap-2 justify-center">
                                    <div class="{{ $columnCount === 1 ? 'border border-black' : 'hover:border-gray-500' }} rounded py-2 px-3 flex-1 cursor-pointer">
                                        <div data-page-click="setColumnCount(1)" class="flex justify-center gap-0.5 items-center">
                                    ...
                                    <div class="{{ $columnCount === 2 ? 'border border-black' : 'hover:border-gray-500' }} rounded py-2 px-3 flex-1 cursor-pointer">
                                        <div data-page-click="setColumnCount(2)" class="flex justify-center gap-0.5 items-center">
                                            <div class="w-4 h-6 bg-gray-300"></div>
                                            <div class="w-4 h-6 bg-gray-300"></div>
                                        </div>
                                    </div>
                                    <div class="{{ $columnCount === 3 ? 'border border-black' : 'hover:border-gray-500' }} rounded py-2 px-3 flex-1 cursor-pointer">
                                        <div data-page-click="setColumnCount(3)" class="flex justify-center gap-0.5 items-center">
                                            <div class="w-4 h-6 bg-gray-300"></div>
                                            <div class="w-4 h-6 bg-gray-300"></div>
                                            <div class="w-4 h-6 bg-gray-300"></div>
                                        </div>
                            ...
                            <div class="bg-gray-100 p-2 rounded flex justify-between items-center my-1"><span class="bangla">কলাম ডিভাইডার</span>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer" data-page-model.live="previewOptions.showColumnDivider" checked="">
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:peer-focus:ring-emerald-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="my-5">
                        ...
                        <div>
                            ...
                            <div>
                                <div data-page-click="shuffleQuestions" class="cursor-pointer bg-gray-100 hover:bg-emerald-600 hover:text-white flex justify-between items-center p-2 rounded my-1">
                                    <p>শাফল (সেট কোড তৈরী) </p>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M403.8 34.4c12-5 25.7-2.2 34.9 6.9l64 64c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-64 64c-9.2 9.2-22.9 11.9-34.9 6.9s-19.8-16.6-19.8-29.6V160H352c-10.1 0-19.6 4.7-25.6 12.8L284 229.3 244 176l31.2-41.6C293.3 110.2 321.8 96 352 96h32V64c0-12.9 7.8-24.6 19.8-29.6s25.7-2.2 34.9 6.9l64 64c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-64 64zM164 282.7L204 336l-31.2 41.6C154.7 401.8 126.2 416 96 416H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96c10.1 0 19.6-4.7 25.6-12.8L164 282.7zm274.6 188c-9.2 9.2-22.9 11.9-34.9 6.9s-19.8-16.6-19.8-29.6V416H352c-30.2 0-58.7-14.2-76.8-38.4L121.6 172.8c-6-8.1-15.5-12.8-25.6-12.8H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96c30.2 0 58.7 14.2 76.8 38.4L326.4 339.2c6 8.1 15.5 12.8 25.6 12.8h32V320c0-12.9 7.8-24.6 19.8-29.6s25.7-2.2 34.9 6.9l64 64c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-64 64z"></path></svg>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-100 my-1 p-2">
                                <div class="rounded flex justify-between items-center"><span class="bangla">জলছাপ</span>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" class="sr-only peer" data-page-model.live="previewOptions.showWatermark">
                                        <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:peer-focus:ring-emerald-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
                                    </label>
                                </div>
                            </div>
                            @if($previewOptions['showWatermark'])
                                <div class="p-2 border border-dashed border-gray-400 rounded-lg mt-2">
                                    <div class="mt-2 p-1 bg-gray-100 rounded flex justify-between items-center">
                                        ...
                                        <input type="range" min="10" max="50" step="5" data-page-model.live="watermarkOpacity">
                                    ...
                                    <div class="bg-gray-100 rounded flex justify-between items-center mt-1">
                                        ...
                                        <input type="range" min="15" max="50" step="5" data-page-model.live="watermarkSize">
                                        <span>{{ $watermarkSize }}</span>
                                    </div>
                                    <textarea class="mt-2 w-full" data-page-model.live="organizationName"></textarea>
                                </div>
                            @endif
                        </div>
                    </div>
