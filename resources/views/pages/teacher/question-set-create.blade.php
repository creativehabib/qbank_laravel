<div class="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden transition-all duration-500">
    ...
    <div class="w-full">
        ...
        <div class="p-6 relative">
            ...
            <form data-page-submit.prevent="saveQuestionSet" class="space-y-6">
                <!-- পরীক্ষার নাম -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700">প্রোগ্রাম/পরীক্ষার নাম লিখুন *</label>
                    <input type="text" data-page-model.defer="name" id="name" placeholder="প্রোগ্রাম/পরীক্ষার নাম লিখুন" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select data-page-model.live="selectedClass" id="selectedClass" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <div class="mt-1 space-y-2 border rounded-md p-3 max-h-48 overflow-y-auto bg-gray-50">
                                @foreach($subjects as $subject)
                                    <label class="flex items-center hover:bg-gray-100 p-1 rounded cursor-pointer">
                                        <input type="checkbox" data-page-model.live="selectedSubjects" value="{{ $subject->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                        ...
                        @if($chapters->isNotEmpty())
                            <div class="mt-1 space-y-2 border rounded-md p-3 max-h-48 overflow-y-auto bg-gray-50">
                                @foreach($chapters as $chapter)
                                    <label class="flex items-center hover:bg-gray-100 p-1 rounded cursor-pointer">
                                        <input type="checkbox" data-page-model.live="selectedChapters" value="{{ $chapter->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                    ...
                    @if($topics->isNotEmpty())
                        <div class="mt-1 space-y-2 border rounded-md p-3 max-h-48 overflow-y-auto bg-gray-50 grid grid-cols-1 md:grid-cols-2 gap-x-4">
                            @foreach($topics as $topic)
                                <label class="flex items-center hover:bg-gray-100 p-1 rounded cursor-pointer">
                                    <input type="checkbox" data-page-model.live="selectedTopics" value="{{ $topic->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-1/3">
                        ...
                        <select data-page-model.defer="type" id="type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="w-2/3">
                        ...
                        <input type="number" data-page-model.defer="quantity" id="quantity" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
