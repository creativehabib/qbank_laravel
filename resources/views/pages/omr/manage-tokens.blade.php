<div class="p-6 bg-gray-100 min-h-screen">
    <div class="max-w-6xl mx-auto bg-white rounded shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button data-page-click="openModal" class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-5 rounded transition">
                + New Token
            </button>
        </div>
        ...
        <div class="w-full fixed top-0 left-0 z-[100] h-[100vh] bg-black/30 flex justify-center items-center">
            <div class="w-full md:w-96 bg-slate-700 text-white rounded shadow-lg mx-2 overflow-auto max-h-[90vh]">
                ...
                <div class="flex text-lg items-center justify-between px-3 py-2">
                    ...
                    <div data-page-click="closeModal" class="text-gray-600 cursor-pointer hover:bg-gray-200 flex items-center justify-center text-lg bg-gray-100 rounded h-7 w-7 transition">
                ...
                <div class="bg-white p-4 text-black">
                    ...
                    <form data-page-submit.prevent="generateToken">
                        <div class="bg-white mt-3">
                            <input data-page-model="title" class="my-1 w-full border rounded p-2 focus:ring-2 focus:ring-green-400 focus:outline-none" type="text" placeholder="পরীক্ষা বা একটি টাইটেল দিন">
                            ...
                            <div class="my-3">
                                ...
                                <div class="flex gap-4">
                                    @foreach($templates as $template)
                                        <div data-page-click="selectTemplate({{ $template->id }}, '{{ $template->type }}')"
                            ...
                            @if($templateType !== 'signature')
                                <div class="flex gap-2 my-2 transition-all duration-300">
                                    ...
                                    <div class="w-full">
                                        <input data-page-model.live="unique_code" type="text" class="border rounded p-2 w-full focus:ring-2 focus:ring-green-400 focus:outline-none" placeholder="যেমন: 13130">
                                        @error('unique_code') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="w-full">
                                        <input data-page-model="totalQuestions" type="number" readonly class="border rounded p-2 w-full bg-gray-100 text-gray-500 font-bold cursor-not-allowed focus:outline-none" placeholder="Total Question">
                            ...
                            <div class="mt-2">
                                <select data-page-model="negativeMark" class="border rounded p-2 w-full focus:ring-2 focus:ring-green-400 focus:outline-none text-gray-700">
