<div class="p-6 bg-gray-100 min-h-screen">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow border p-6">
                ...
                <div class="flex items-center justify-between border-b pb-2 border-gray-200">
                    ...
                    <div class="flex gap-2">
                        @foreach(['A' => 'ক', 'B' => 'খ', 'C' => 'গ', 'D' => 'ঘ'] as $optCode => $optLabel)
                            <button data-page-click="setAnswer({{ $q }}, '{{ $optCode }}')"
        ...
        <div class="mt-8 flex flex-col gap-3 max-w-xs mx-auto">
            <button data-page-click="saveAnswers" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2.5 rounded transition shadow">
                Save করুন
            </button>
            <button data-page-click="completeSetup" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded transition shadow">
