        ...
        @if(!$result)
            <div class="space-y-6">
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-gray-50 hover:bg-gray-100 transition relative">
                    <input type="file" data-page-model="omrImage" class="hidden" id="omrFile">
                ...
                <div>
                    ...
                    <select data-page-model="tokenId" class="w-full border-gray-300 rounded shadow-sm">
                ...
                <button data-page-click="evaluate" data-page-loading.attr="disabled" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded transition flex items-center justify-center gap-2">
                    <span data-page-loading.remove>Evaluate Now!</span>
                    <span data-page-loading>স্ক্যান হচ্ছে, দয়া করে অপেক্ষা করুন...</span>
                </button>
            </div>
        @else
            <div class="bg-gray-50 rounded border p-6 text-center animate-fade-in">
                ...
                <button data-page-click="$set('result', null)" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-6 rounded transition">
