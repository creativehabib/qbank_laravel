<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <flux:card class="group hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
            <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <flux:button wire:click="clearApplicationCache" wire:loading.attr="disabled" size="sm" variant="outline" class="shrink-0 w-full sm:w-auto">
        ...
        <flux:card class="group hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
            <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <flux:button wire:click="clearViewCache" wire:loading.attr="disabled" size="sm" variant="outline" class="shrink-0 w-full sm:w-auto">
        ...
        <flux:card class="group hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
            <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <flux:button wire:click="clearConfigCache" wire:loading.attr="disabled" size="sm" variant="outline" class="shrink-0 w-full sm:w-auto">
        ...
        <flux:card class="group hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
            <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <flux:button wire:click="clearRouteCache" wire:loading.attr="disabled" size="sm" variant="outline" class="shrink-0 w-full sm:w-auto">
    ...
    <!-- Optimize All -->
    <flux:card class="bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 relative overflow-hidden group">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <flux:button wire:click="optimizeClear" wire:loading.attr="disabled" variant="primary" class="shrink-0 w-full md:w-auto shadow-sm">
