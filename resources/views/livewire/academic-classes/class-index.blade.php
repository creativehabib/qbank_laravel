    ...
    <x-slot:form>
        ...
        @else
            ...
            <flux:field>
                ...
                <flux:input wire:model.live.debounce.1000ms="class_name" placeholder="E.g. Job Prep, BCS, Class 6" />
            ...
            <flux:field x-data="{ editingSlug: false }">
                ...
                <flux:input wire:model="class_slug" x-bind:disabled="!editingSlug" placeholder="e.g. job-prep" class="bg-gray-50 disabled:opacity-75" />
                <flux:error name="class_slug" />
            </flux:field>
