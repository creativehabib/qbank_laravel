<div class="mx-auto w-full max-w-3xl space-y-6">
    ...
    <form wire:submit="save" class="space-y-4 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        <flux:input wire:model.live.blur="organizationName" label="প্রতিষ্ঠানের নাম" placeholder="যেমন: ঢাকা কলেজ" />
        <flux:input wire:model.live.blur="organizationType" label="প্রতিষ্ঠানের ধরন" placeholder="যেমন: কলেজ / স্কুল / মাদ্রাসা" />
        <flux:textarea wire:model.live.blur="organizationAddress" label="প্রতিষ্ঠানের ঠিকানা" rows="4" />
