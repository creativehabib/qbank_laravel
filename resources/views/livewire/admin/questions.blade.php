            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    @if($canCreateQuestion)
                        <flux:button href="{{ route('questions.bulk-upload') }}" data-navigate="false" variant="outline" icon="arrow-up-tray">Bulk upload</flux:button>
                        <flux:button href="{{ route('questions.create') }}" data-navigate="false" variant="primary" icon="plus">New question</flux:button>
                    @endif
                </div>
            </div>
                                ...
                                <div class="flex justify-end gap-1">
                                    ...
                                    @elseif($quickFilter !== 'trash')
                                        ...
                                        @if($currentUser?->hasPermission('questions.update') && (! $currentUser->isTeacher() || $question->user_id === $currentUser->id))
                                            <flux:button size="sm" variant="ghost" icon="pencil-square" href="{{ route('questions.edit', $question) }}" data-navigate="false" aria-label="Edit question" />
                                        @endif
