<div x-data="{ questionType: $wire.entangle('question_type') }" class="w-full !max-w-full mx-auto">
...
@push('scripts')
    ...
    <script>
        ...
        if (!window.hasRegisteredQuestionEvents) {
            ...
            document.addEventListener('livewire:initialized', () => setTimeout(initEditors, 100));
