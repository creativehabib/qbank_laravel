            ...
            <div class="flex flex-col gap-8 p-6 lg:p-8 w-full">
                ...
                <div class="flex-1 space-y-8 w-full">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div wire:key="image-upload-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm space-y-4 transition hover:shadow-md h-full">
                        ...
                        {{-- Settings Card --}}
                        <div wire:key="settings-card" class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm space-y-5 h-full transition hover:shadow-md">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select wire:model="difficulty" class="w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-3 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 transition shadow-sm">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" min="0.25" step="0.25" wire:model="marks" class="w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-indigo-500 transition shadow-sm pr-12">
                    ...
                    <div wire:key="action-buttons-card" class="flex flex-wrap items-center gap-3 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 p-4 rounded-2xl border border-indigo-100 dark:border-indigo-900 shadow-sm">
                        ...
                        <label class="flex items-center gap-2 mr-4 cursor-pointer">
                            <input type="checkbox" wire:model="enrichWithAi" class="w-5 h-5 rounded border-indigo-300 text-indigo-600 focus:ring-indigo-500 bg-white dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <div wire:key="processed-questions-card" class="rounded-2xl border border-indigo-200 dark:border-indigo-800 shadow-sm overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/30 dark:via-gray-900 dark:to-purple-950/30 transition">
                            ...
                            <div class="p-5 space-y-5" id="processed-questions-container"
                                ...
                                @foreach($processedQuestions as $questionIndex => $question)
                                    ...
                                    @endphp
                                    <div wire:key="question-{{ $questionIndex }}" @class([
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex flex-shrink-0 items-center gap-2 mt-0.5">
                                                ...
                                                @endif
                                                <button type="button" wire:click="removeProcessedQuestion({{ $questionIndex }})" title="প্রশ্নটি মুছে ফেলুন" class="inline-flex items-center justify-center p-2 rounded-lg text-red-500 hover:text-white hover:bg-red-500 dark:text-red-400 dark:hover:text-white dark:hover:bg-red-500 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 transition-colors shadow-sm">
                                        ...
                                        <div class="ml-11 mb-3 mt-1 grid grid-cols-1 lg:grid-cols-2 gap-4 border border-gray-100 dark:border-gray-800 rounded-xl p-3 bg-gray-50/50 dark:bg-gray-800/30">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex flex-wrap items-center gap-2">
                                                    <!-- Subject -->
                                                    <select wire:model.live="processedQuestions.{{$questionIndex}}.subject_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500 @empty($question['subject_id']) border-red-200 dark:border-red-900/50 bg-red-50/30 dark:bg-red-900/10 @endempty">
                                                    ...
                                                    <select wire:model.live="processedQuestions.{{$questionIndex}}.chapter_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500">
                                                    ...
                                                    <svg class="w-3 h-3 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                                                    <select wire:model="processedQuestions.{{$questionIndex}}.topic_id" class="w-28 text-xs px-2 py-1.5 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 outline-none focus:ring-1 focus:ring-indigo-500">
                                                            ...
                                                            if(window.TomSelect) {
                                                                this.ts = new TomSelect(this.$refs.classes, {
                                                                    ...
                                                                    onChange: (v) => { 
                                                                        ...
                                                                        this.classIds = val;
                                                                        $wire.set('processedQuestions.{{ $questionIndex }}.academic_class_ids', val, false);
                                                                    }
                                                                });
                                        ...
                                        @if(!empty($question['explanation']))
                                            <div class="ml-11 mb-3 mt-1 p-3 rounded-lg bg-emerald-50 border border-emerald-100 dark:bg-emerald-900/10 dark:border-emerald-900/30 relative group">
                                                ...
                                                <button type="button" wire:click="$set('processedQuestions.{{ $questionIndex }}.explanation', '')" title="ব্যাখ্যা মুছে ফেলুন" class="absolute top-2 right-2 p-1.5 rounded-md text-emerald-400 hover:text-white hover:bg-red-500 transition-colors opacity-0 group-hover:opacity-100">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pl-11">
                                            @foreach($question['options'] as $optionIndex => $option)
                                                ...
                                                <div wire:key="option-{{ $questionIndex }}-{{ $optionIndex }}" @class([
...
@push('scripts')
    ...
    <script>
        ...
        if (!window.hasRegisteredBulkUploadEvents) {
            ...
            document.addEventListener('livewire:initialized', () => setTimeout(window.initBulkUploadComponents, 100));
