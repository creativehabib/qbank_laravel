        ...
        @else
            <form wire:submit="save" wire:key="form-{{ $editId ?? 'create' }}" class="space-y-4">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model.live.debounce.500ms="name" placeholder="e.g. Mathematics" />
                ...
                <flux:field x-data="{ editingSlug: false }">
                    ...
                    <flux:input wire:model="slug" x-bind:disabled="!editingSlug" placeholder="e.g. mathematics" class="bg-gray-50 disabled:opacity-75" />
