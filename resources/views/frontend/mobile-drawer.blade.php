...
<div id="mobile-drawer" class="fixed top-0 bottom-0 right-0 z-[70] w-[85%] max-w-sm bg-slate-50 dark:bg-[#121B2B] shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out md:hidden flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-5 no-scrollbar">
        ...
        <div id="mobilePwaBanner" class="hidden bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/40 dark:to-teal-900/40 border border-emerald-200 dark:border-emerald-500/20 p-3.5 rounded-xl flex items-center justify-between">
            <div class="flex items-center gap-2.5">
                <div class="p-1.5 bg-emerald-100 dark:bg-emerald-500/20 rounded-lg text-emerald-600 dark:text-emerald-400"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                <div>
                    <h4 class="text-xs font-bold text-slate-900 dark:text-white">কেরোবি.কম অ্যাপ <span class="bg-emerald-500 text-white text-[8px] px-1 rounded">PWA</span></h4>
                    <p class="text-[10px] text-slate-500 dark:text-slate-400">১ ক্লিকে ফোনে অ্যাপ হিসেবে...</p>
                </div>
            </div>
            <button class="installPwaBtn bg-emerald-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-lg flex items-center gap-1">
        ...
        <div>
            <h4 class="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mb-2 px-1">মূল পোর্টালসমূহ</h4>
        ...
        <div>
            <h4 class="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mb-2 px-1">সাইটের তথ্য ও সহায়িকা</h4>
            <div class="grid grid-cols-2 gap-2">
                <a href="#" class="flex justify-between items-center p-2.5 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-slate-600 dark:text-slate-400 text-[11px]">আমাদের সম্পর্কে <span class="text-slate-400 dark:text-slate-500">&rsaquo;</span></a>
                <a href="#" class="flex justify-between items-center p-2.5 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-slate-600 dark:text-slate-400 text-[11px]">ব্যবহারের শর্তাবলী <span class="text-slate-400 dark:text-slate-500">&rsaquo;</span></a>
                <a href="{{ route('pages.privacy') }}" class="flex justify-between items-center p-2.5 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-slate-600 dark:text-slate-400 text-[11px]">গোপনীয়তা নীতি <span class="text-slate-400 dark:text-slate-500">&rsaquo;</span></a>
                <a href="#" class="flex justify-between items-center p-2.5 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-slate-600 dark:text-slate-400 text-[11px]">যোগাযোগ <span class="text-slate-400 dark:text-slate-500">&rsaquo;</span></a>
            </div>
        </div>
