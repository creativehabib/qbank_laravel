...
namespace App\Http\Controllers\Pages\Topics;
...
class TopicIndex extends PageController
{
    ...
    public function cancelEdit()
    {
        ...
        $this->reset(['isCreating', 'name', 'slug', 'modalSubjectId', 'modalChapterId', 'editId']);
    ...
    public function save()
    {
        ...
        $this->validate([
            ...
            'slug' => 'required|string|max:255|unique:topics,slug,'.$this->editId,
            'name' => [
                'required',
                'string',
    ...
    public function render()
    {
        ...
        return view('pages.topics.topic-index', [
            'topics' => $topics,
