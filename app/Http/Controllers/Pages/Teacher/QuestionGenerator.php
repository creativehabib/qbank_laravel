...
class QuestionGenerator extends PageController
{
    public $perPage = 10;
    ...
    {
        if (! $this->programName && auth()->user()?->organization_name) {
            $this->programName = (string) auth()->user()->organization_name;
        }
    }
    ...
    {
        return view('pages.teacher.question-generator-copy', [
