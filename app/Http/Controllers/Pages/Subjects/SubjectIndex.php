...
namespace App\Http\Controllers\Pages\Subjects;
...
class SubjectIndex extends PageController
{
    ...
    public function cancelEdit()
    {
        ...
        $this->reset([
            'editId', 'academic_class_ids', 'name', 'subject_code', 'slug',
            'description', 'image',
        ]);
        $this->is_active = true;
    ...
    public function save()
    {
        ...
        $this->validate([
            ...
            'slug' => 'required|string|max:255|unique:subjects,slug,'.$this->editId,
    ...
    public function render()
    {
        ...
        return view('pages.subjects.subject-index', compact('subjects', 'classes'))
