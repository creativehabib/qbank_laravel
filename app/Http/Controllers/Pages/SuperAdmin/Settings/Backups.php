...
class Backups extends PageController
{
    ...
    public function downloadBackup($file)
    {
        ...
        if ($disk->exists($file)) {
            // page controller will trigger a front-end redirect to this route, preventing page controller from buffering the file
    ...
    public function render()
    {
        ...
        return view('pages.superadmin.settings.backups')->layout('layouts.app', ['title' => 'System Backups']);
    }
}
