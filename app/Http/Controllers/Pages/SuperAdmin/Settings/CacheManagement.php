...
class CacheManagement extends PageController
{
    ...
    public function clearApplicationCache()
    {
        ...
        log_activity('cleared_cache', 'Cleared Application Cache');
    ...
    public function render()
    {
        ...
        return view('pages.superadmin.settings.cache-management')->layout('layouts.app', ['title' => 'Cache Management']);
    }
}
