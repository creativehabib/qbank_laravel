...
class AiSetting extends PageController
{
    ...
    public function save()
    {
        ...
        log_activity('updated_settings', 'Updated AI Settings');
    ...
    {
        return view('pages.admin.settings.ai-setting')->layout('layouts.app', ['title' => 'AI Settings']);
    }
}
