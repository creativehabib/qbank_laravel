...
class GeneralSetting extends PageController
{
    ...
    public function save()
    {
        ...
        log_activity('updated_settings', 'Updated General Settings');
    ...
    {
        return view('pages.admin.settings.general-setting')->layout('layouts.app', ['title' => 'General Settings']);
    }
}
