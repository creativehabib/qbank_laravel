...
class FooterSetting extends PageController
{
    public $about_text;
    ...
    public function save()
    {
        ...
        $this->toast('Frontend Footer settings updated successfully!', 'success', 'Success');
    }

    public function render()
    {
        return view('pages.admin.settings.footer-setting')
