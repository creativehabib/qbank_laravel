...
namespace App\Http\Controllers\Pages\Admin\Organizations;
...
class OrganizationIndex extends PageController
{
    use InteractsWithUploads, InteractsWithPagination;
    ...
    {
        return view('pages.admin.organizations.organization-index', [
