...
namespace App\Http\Controllers\Pages\ExamCategories;
...
class ExamCategoriesIndex extends PageController
{
    ...
    public function render()
    {
        ...
        return view('pages.exam-categories.exam-categories-index', [
