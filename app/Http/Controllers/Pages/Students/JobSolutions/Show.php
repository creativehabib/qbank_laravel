...
class Show extends PageController
{
    public $exam;
    ...
    public function mount($organizationSlug, $examSlug)
    {
    ...
    public function render()
    {
        ...
        $otherOrganizations = Organization::where('id', '!=', $this->organization->id)
            ->withCount('pastExams')
        ...
        return view('pages.students.job-solutions.show', [
