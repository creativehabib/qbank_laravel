...
class MenuBuilder extends Component
{
    ...
    public function saveItem()
    {
        ...
        if ($this->editingItemId) {
            ...
            Flux::toast('Menu item updated!', 'Success');
        } else {
            ...
            Flux::toast('Menu item added!', 'Success');
        }
    ...
    public function deleteItem($id)
    {
        ...
        Flux::toast('Menu item deleted.', 'Success');
    }
    ...
    public function updateOrder($orderedIds)
    {
        ...
        Flux::toast('Menu order updated successfully!', 'Success');
    }

    public function render()
    {
        return view('livewire.admin.settings.menu-builder')
